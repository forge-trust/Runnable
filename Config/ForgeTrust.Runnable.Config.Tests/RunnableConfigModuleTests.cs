...
public class RunnableConfigModuleTests
{
    ...
    public void ConfigureServices_AddsRequiredServices()
    {
        ...
        Assert.Contains(services, d => d.ServiceType == typeof(IConfigManager) && d.ImplementationType == typeof(DefaultConfigManager));
        Assert.Contains(services, d => d.ServiceType == typeof(IEnvironmentConfigProvider) && d.ImplementationType == typeof(EnvironmentConfigProvider));
        Assert.Contains(services, d => d.ServiceType == typeof(IConfigFileLocationProvider) && d.ImplementationType == typeof(DefaultConfigFileLocationProvider));
        Assert.Contains(services, d => d.ServiceType == typeof(IConfigProvider) && d.ImplementationType == typeof(FileBasedConfigProvider));
    ...
    public void CustomRegistrationTask_ScansAssembliesAndRegistersConfigs()
    {
        ...
        var module = new RunnableConfigModule();
        module.RegisterDependentModules(null!);
        ...
        // Verify it registered TestConfig
        ...
        var resolved = sp.GetRequiredService<TestConfig>();
        
        Assert.NotNull(resolved);
        // Verify Init was called
        A.CallTo(() => configManager.GetValue<TestConfig>(A<string>._, A<string>._))
            .MustHaveHappened();
    }
}
